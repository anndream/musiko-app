...
object ThemeHelper {
    ...
    fun applyChanges(activity: Activity) {
        ...
        val bundle = bundleOf(Pair(MusikoConstants.RESTORE_SETTINGS_FRAGMENT, true))
    ...
    fun resolveSortAlbumSongsIcon(sort: Int): Int {
        ...
        return if (isFileNameSongs) {
            when (sort) {
                MusikoConstants.ASCENDING_SORTING -> R.drawable.ic_sort_alphabetical_descending
                else -> R.drawable.ic_sort_alphabetical_ascending
            }
        } else {
            when (sort) {
                MusikoConstants.ASCENDING_SORTING -> R.drawable.ic_sort_alphabetical_descending
                MusikoConstants.DESCENDING_SORTING -> R.drawable.ic_sort_alphabetical_ascending
                MusikoConstants.TRACK_SORTING -> R.drawable.ic_sort_numeric_descending

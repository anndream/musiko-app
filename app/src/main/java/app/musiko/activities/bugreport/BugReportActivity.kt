...
package app.musiko.activities.bugreport
...
import app.musiko.R
import app.musiko.activities.base.AbsThemeActivity
import app.musiko.activities.bugreport.model.DeviceInfo
import app.musiko.activities.bugreport.model.Report
import app.musiko.activities.bugreport.model.github.ExtraInfo
import app.musiko.activities.bugreport.model.github.GithubLogin
import app.musiko.activities.bugreport.model.github.GithubTarget
import app.musiko.misc.DialogAsyncTask
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        ...
        private const val ISSUE_TRACKER_LINK = "https://github.com/h4h13/MusikoPlayer"
    }
}

...
import app.musiko.ui.AlbumsViewHolder
import app.musiko.ui.GenericViewHolder
...
class DetailsFragment : Fragment(R.layout.fragment_details), SearchView.OnQueryTextListener {
    ...
    private var mLaunchedBy = MusikoConstants.ARTIST_VIEW
    ...
    private val sLaunchedByArtistView get() = mLaunchedBy == MusikoConstants.ARTIST_VIEW
    private val sLaunchedByFolderView get() = mLaunchedBy == MusikoConstants.FOLDER_VIEW

    private val sIsFileNameSongs get() = goPreferences.songsVisualization != MusikoConstants.TITLE
        ...
        mDetailsFragmentBinding.detailsToolbar.apply {
            ...
            setOnMenuItemClickListener {
                ...
                when (it.itemId) {
                    ...
                    R.id.default_sorting -> applySortingToMusic(MusikoConstants.DEFAULT_SORTING)
                    R.id.descending_sorting -> applySortingToMusic(MusikoConstants.DESCENDING_SORTING)
                    R.id.ascending_sorting -> applySortingToMusic(MusikoConstants.ASCENDING_SORTING)
                    R.id.track_sorting -> applySortingToMusic(MusikoConstants.TRACK_SORTING)
                    R.id.track_sorting_inv -> applySortingToMusic(MusikoConstants.TRACK_SORTING_INVERTED)
                }
    ...
    private fun swapAlbum(songs: MutableList<Music>?) {
        mSongsSorting = MusikoConstants.TRACK_SORTING

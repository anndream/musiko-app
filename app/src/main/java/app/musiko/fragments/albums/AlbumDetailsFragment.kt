...
import app.musiko.activities.tageditor.AlbumTagEditorActivity
import app.musiko.adapter.album.HorizontalAlbumAdapter
import app.musiko.adapter.song.SimpleSongAdapter
...
import app.musiko.glide.SingleColorTarget
import app.musiko.helper.MusicPlayerRemote
import app.musiko.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import app.musiko.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import app.musiko.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import app.musiko.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
    ...
    private fun loadArtistImage(artist: Artist) {
        ...
        ArtistGlideRequest.Builder.from(Glide.with(requireContext()), artist)
            ...
            .dontAnimate()
            .dontTransform()
            .into(object : MusikoColoredTarget(artistImage) {

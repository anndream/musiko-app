...
import app.musiko.R
import app.musiko.adapters.AccentsAdapter
import app.musiko.adapters.ActiveTabsAdapter
import app.musiko.adapters.FiltersAdapter
...
class PreferencesFragment : PreferenceFragmentCompat(),
    ...
    override fun onPreferenceClick(preference: Preference?): Boolean {
        when (preference?.key) {
            getString(R.string.open_git_pref) -> openCustomTab(getString(R.string.app_site))

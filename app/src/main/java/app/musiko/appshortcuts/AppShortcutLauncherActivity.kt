...
import app.musiko.appshortcuts.shortcuttype.LastAddedShortcutType
import app.musiko.appshortcuts.shortcuttype.ShuffleAllShortcutType
import app.musiko.appshortcuts.shortcuttype.TopTracksShortcutType
import app.musiko.extensions.extraNotNull
import app.musiko.model.Playlist
import app.musiko.model.smartplaylist.LastAddedPlaylist
import app.musiko.model.smartplaylist.ShuffleAllPlaylist
import app.musiko.model.smartplaylist.TopTracksPlaylist
...
class AppShortcutLauncherActivity : Activity() {
    ...
    companion object {
        const val KEY_SHORTCUT_TYPE = "app.musiko.appshortcuts.ShortcutType"

...
import app.musiko.*
import app.musiko.extensions.getIntRes
import app.musiko.extensions.getStringOrDefault
import app.musiko.fragments.AlbumCoverStyle
import app.musiko.fragments.NowPlayingScreen
import app.musiko.fragments.folder.FoldersFragment
import app.musiko.helper.SortOrder.*
import app.musiko.model.CategoryInfo
import app.musiko.transform.*
...
object PreferenceUtil {
    ...
    fun themeResFromPrefValue(themePrefValue: String): Int {
        return when (themePrefValue) {
            ...
            "dark" -> R.style.Theme_Musiko
            else -> R.style.Theme_Musiko
        }
    }
